...
export default function About({ me }) {
  ...
  >
      ...
      <div className="absolute inset-0 z-10 vh-100">
          <Particles 
      ...
      {/* Content on top */}
        <div className="relative z-0 w-full max-w-275">
          {/* Section header */}
          ...
          {/* Main content card */}
          <div className="bg-card-bg border border-card-border rounded-(--radius-card) p-8 md:p-10 shadow-(--shadow-card) mb-8 backdrop-blur-md">
